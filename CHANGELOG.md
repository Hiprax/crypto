...
- `CLAUDE.md` — Constructor Options table upper bounds; `encryptFileSync` method bullet and design decision §9 updated to reflect chunked streaming; Entry Point exports; dependency claim; Argon2 lazy-load fallback chain; published files list; tsconfig outputs; PBKDF2 default; test-script commands; overview version.
